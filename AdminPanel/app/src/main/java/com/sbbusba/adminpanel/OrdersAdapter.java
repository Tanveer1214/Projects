...
import com.sbbusba.adminpanel.databinding.OrderRowBinding;
...
public class OrdersAdapter extends RecyclerView.Adapter<OrdersAdapter.ProductViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ProductViewHolder holder, int position) {
        ...
        holder.binding.updatedOn.setText(orderModel.getUpdatedOn()!=null?format.format(orderModel.getUpdatedOn()):"");
